 ...
 */
export declare function AIChatbot({ provider, config, onMessageSent, onMessageReceived, onError, onSessionStart, onSessionEnd, className, style, user, userId, saveSessionHistory, loadSessionId, initialMessages, showNewChatButton, showHeader, formClassName, containerClassName, textareaClassName, buttonClassName }: AIChatbotProps): import("react/jsx-runtime").JSX.Element;
