 ...
 */
export function mergeWithDefaults(userConfig: ChatbotConfig): Required<Omit<ChatbotConfig, 'topicContext' | 'onMessageSent' | 'onResponseReceived' | 'className' | 'style'>> & Pick<ChatbotConfig, 'topicContext' | 'onMessageSent' | 'onResponseReceived' | 'className' | 'style'> {
  return {
